...
namespace StrumentiMusicali.App.Core.Controllers.ListiniFornitori
{
    ...
    public class ControllerListinoPrezziCliente : BaseControllerGeneric<ListinoPrezziFornitori, ListinoPrezziFornitoriItem>, IDisposable
    {
        ...
        public ControllerListinoPrezziCliente(ControllerArticoli controllerMaster, bool gestioneInline)
        ...
        // exactly as they are.
        ~ControllerListinoPrezziCliente()
        {
