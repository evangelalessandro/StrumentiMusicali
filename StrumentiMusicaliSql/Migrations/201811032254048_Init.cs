        ...
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Codice = c.String(nullable: false, maxLength: 10),
            ...
            CreateTable(
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Pagamento = c.String(nullable: false),
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Articoli", t => t.ArticoloID)
                .ForeignKey("dbo.Fatture", t => t.FatturaID)
                .Index(t => t.FatturaID)
                .Index(t => t.ArticoloID);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Articoli", t => t.ArticoloID)
                .ForeignKey("dbo.Depositi", t => t.DepositoID)
                .Index(t => t.ArticoloID)
